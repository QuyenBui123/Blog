  ...
  return (
    <>
      <div className="flex p-4 border-b dark:border-gray-600 text-sm">
        ...
        <div className="flex-1">
          <div className="flex items-center mb-1">
            <span className="font-bold mr-1 text-xs truncate">NameTest</span>
          ...
          <div className="flex items-center pt-2 text-xs border-t dark:border-gray-700 max-w-fit gap-2">
            ...
            <p className="text-gray-400">1 like</p>
      ...
      <form className="border border-teal-500 rounded-md p-3 mt-4">
        <Textarea placeholder="Add a comment..." rows={3} maxLength={2000} />
