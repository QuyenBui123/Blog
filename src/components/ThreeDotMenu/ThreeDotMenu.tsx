...
const ThreeDotMenu = () => {
  ...
  const handleShareZalo = () => {
    const zaloUrl = `https://zalo.me/share?url=${encodeURIComponent(window.location.href)}`;
  ...
  <div className='flex items-center'>
    ...
    <div className="relative inline-block text-right">
      ...
      <div className="absolute right-0 mt-2 w-48   rounded-md shadow-lg ">
        ...
        <ListGroup.Item onClick={handleShareFacebook}><FaFacebook className="mr-2" /> Share Facebook</ListGroup.Item>
        <ListGroup.Item onClick={handleShareZalo}><FiShare className="mr-2" /> Share Zalo</ListGroup.Item>
