...
export default function SignIn() {
  const [formValues, setFormValues] = useState<FormValues>({ email: 'test@gmail.com', password: '123456' })
  ...
  return (
    ...
    <div className='min-h-screen mt-20 ' >
      ...
      <p className='text-sm mt-5'>This is a demo project. You can sign with your email and password or with Google.</p>
        </div>
        {/* right */}
        <div className='flex-1'>
